...
def main(options, main_comm, debugMsg):
    ...
    if rank == 0:
        ...
        print 'cmip6:',envDict['cmip6']
        print 'filelist:',envDict['filelist']
        print 'matrix_2d_fname:',envDict['matrix_2d_fname']
        print 'matrix_3d_fname:',envDict['matrix_3d_fname']
        print 'indir:',envDict['indir']
        print 'outdir:',envDict['outdir']
        print 'chunk size:',envDict['chunk']
